...
namespace LuceneWrapper
{
    ...
    /// </summary>
    public abstract class BaseSearcher<M> : BaseSearch
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(BaseSearcher<M>));
        ...
        protected SearchResult Search<T>(string searchQuery, string field=null) where T : IndexedDocument<M>
        {
            if (field == null)
                field = "SearchableString";
