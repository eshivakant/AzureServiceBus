...
namespace LuceneWrapper
{
    ...
    /// </summary>
    public abstract class BaseWriter<T> : BaseSearch
    {
        ...
        private void AddItemToIndex(IndexedDocument<T> doc, IndexWriter writer)
        {
        ...
        protected void AddUpdateItemsToIndex(IEnumerable<IndexedDocument<T>> docs)
        {
        ...
        /// <param name="writer">The Lucene writer</param>
        private void DeleteItemFromIndex(IndexedDocument<T> doc, IndexWriter writer)
        {
        ...
        protected void DeleteItemsFromIndex(IEnumerable<IndexedDocument<T>> docs)
        {
